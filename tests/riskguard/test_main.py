...
def test_riskguard_main_uses_env_var_for_url() -> None:
    ...
    with (
        patch.dict(os.environ, {"RISKGUARD_SERVICE_URL": public_url}),
        patch("riskguard.__main__.DefaultRequestHandler") as mock_handler,
        patch("uvicorn.Server"),
        patch("riskguard.__main__.riskguard_adk_agent") as mock_agent,
    ):
